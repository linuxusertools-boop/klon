...
// Fungsi mendapatkan waktu format HH:mm
function getTime() {
    return new Date().toLocaleTimeString('id-ID', { hour: '2-digit', minute: '2-digit' });
}

// Fungsi mengambil prompt sistem
...
// Fungsi render pesan dengan dukungan centang dan stiker proporsional
